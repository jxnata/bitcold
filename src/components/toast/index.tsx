	...
	return {
		success: (props: BaseToastProps) => (
			<SuccessToast
				...
				style={{ borderLeftColor: colors.successText, backgroundColor: colors.border }}
				text1Style={{
		...
		info: (props: BaseToastProps) => (
			<InfoToast
				{...props}
				contentContainerStyle={{ paddingHorizontal: 10 }}
				style={{ borderLeftColor: colors.border, backgroundColor: colors.border }}
				text1Style={{
					color: colors.foreground,
					fontSize: 14,
					fontWeight: '400',
		...
		error: (props: BaseToastProps) => (
			<ErrorToast
				{...props}
				contentContainerStyle={{ paddingHorizontal: 10 }}
				style={{ borderLeftColor: colors.dangerText, backgroundColor: colors.border }}
				text1Style={{
					color: colors.foreground,
					fontSize: 14,
					fontWeight: '400',
